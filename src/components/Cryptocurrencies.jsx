...
//so if you look at the map function because certain coins may have data that is undefined without optional chaining youd have an error so now with the ?. you can render through each coin without getting that error 